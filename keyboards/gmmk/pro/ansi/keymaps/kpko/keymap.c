...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_BASE] = LAYOUT(
        KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSCR,          KC_MUTE,
...
void rgb_set_side_colors(uint8_t r, uint8_t g, uint8_t b) {
    rgb_set_list(LED_SIDE_LEFT, ARRAYSIZE(LED_SIDE_LEFT), r, g, b);
    rgb_set_list(LED_SIDE_RIGHT, ARRAYSIZE(LED_SIDE_LEFT), r, g, b); }
